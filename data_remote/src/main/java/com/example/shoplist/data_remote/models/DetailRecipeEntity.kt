...
@Parcelize
data class DetailRecipesEntityResponse(
    @SerializedName("meals") val recipe: List<DetailRecipeEntityResponse> = emptyList()
): Parcelable

@Parcelize
data class DetailRecipeEntityResponse(
    ...
    @SerializedName("strYoutube") val videoUrl: String = "",
